                            ...
                            <div class="card border-left-primary shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                                Barang paling banyak terjual</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">$40,000</div>
                                        </div>
                                        <div class="col-auto">
                                            <i class="fas fa-calendar fa-2x text-gray-300"></i>
                        ...
                        <div class="col-lg-8">
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">Review penjualan</h6>
                                </div>
                                <div class="card-body">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col">
                                                <ul class="list-group-flush">
                                                    ...
                                                    <li class="list-group-item"><?php if ($user['id_role']==1) : ?>
                                                            <?= "Administrator"; ?>
                                                        <?php else : ?>
                                                            <?= "Pegawai"; ?>
                                                        <?php endif; ?></li>
                                                    <li class="list-group-item"><?= date('d F Y', $user['date']); ?></li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
